...
def chyba_one_mark_small(cat, score, x, y, w, h, ):
    ...
    if catdecoded == "cell phone" and w_norm <= 1:
        ...
        #cell_phone[(len(cell_phone)-2)].draw_id()
...
def get_uniqe_id2(cat , score, x , y , w , h):
    ...
    #if (cell_phone[(len(cell_phone)-1)].is_near_by_object()) == True:
...
class Object:
    ...
    def is_near_by_object(self):
        if (abs(self.x_norm - Object.x_norm_last ) <= 0.05) and (abs(self.y_norm - Object.y_norm_last) <= 0.05):
            print("2Je to ten isty object:dif:", abs(self.x_norm - Object.x_norm_last), abs(self.y_norm - Object.y_norm_last), " ako id:", self.id)
            Object.x_norm_last = self.x_norm
            Object.y_norm_last = self.y_norm
            return True
        else:
            print("Nie je to ten isty object:dif:", abs(self.x_norm - Object.x_norm_last), abs(self.y_norm - Object.y_norm_last), " ako id:", self.id )
            Object.x_norm_last = self.x_norm
            Object.y_norm_last = self.y_norm
            return False
    def draw_id(self):
        #print(self.Object.id)
         cv2.putText(frame, str(self.id), (int(self.x), int(self.y)), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 2, 0))

cell_phone.append(Object(cell_phone,0, 0, 0, 0, 0))
